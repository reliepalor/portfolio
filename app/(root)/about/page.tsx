      ...
      <div className="max-w-3xl mx-auto">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border p-6">
              <p className="text-muted-foreground">
                As a 4th year student, I&apos;m constantly learning and improving
                my skills in web development. I&apos;m passionate about creating
                user-friendly, accessible, and modern web experiences that make
                a positive impact.
              </p>
            </div>
          </div>
